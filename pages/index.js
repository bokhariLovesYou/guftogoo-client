          ...
          <div className="flex -mx-3">
              ...
              <div className="py-6 Navigation text-sm sticky top-0">
                ...
                <nav>
                  <ul>
                    ...
                    <li className="mb-2">Beginner</li>
                    <li className="mb-2">React</li>
                    <li className="mb-2">Programming</li>
                    <li className="mb-2">Pyhton</li>
                    <li className="mt-3">
            ...
            <div className="px-3 w-full lg:max-w-[60%]">
              <div className="Timeline border-l border-r">
                <div className="Timeline__Card bg-white py-14 px-5 border-b">
                  <div className="Timeline__Card__Body mb-3">
                    <Heading className="text-theme-primary" tag="h1" size="h2">
